 ...
 */
 ...
 function theme_setup() {
  ...
  add_theme_support( 'menus' );
    ...
    // Example
		 'main-menu' => esc_html__( 'Main Menu', 'mel-theme' ),
		 'large-menu' => esc_html__( 'Large Menu', 'mel-theme' ),
 	) );
 ...
 function theme_styles() {
   ...
   // Example with internal file
	...
	wp_enqueue_style( 'lityCSS', get_template_directory_uri() . '/node_modules/lity/dist/lity.css' );
 ...
 function theme_js() {
   ...
   // Example with internal file
	...
	wp_enqueue_script( 'flickityJSmain', get_template_directory_uri() . '/js/flickity.js', array('jquery'), '', true);
	...
	wp_enqueue_script( 'lityJS', get_template_directory_uri() . '/node_modules/lity/dist/lity.js', array('jquery'), '', true);
 }
...
function wpse156165_menu_add_class( $atts, $item, $args ) {
    $class = 'js-scroll-trigger'; // or something based on $item
    $atts['class'] = $class;
    return $atts;
}
